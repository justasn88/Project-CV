...
@Service
@Profile("!local")
public class GcpScraperDispatchService implements ScraperDispatchService{
    ...
    public GcpScraperDispatchService(ScraperProperties scraperProperties, GcpProperties gcpProperties) {
